...
const Header = () => {
    ...
    const isWhiteLogo = pathname === '/' || pathname === '/logistics-software-development' || pathname === '/healthcare-app-development-services' || pathname === '/education-app-development' || pathname === '/music-app-development-company' || pathname === '/social-media-app-development-company' || pathname === '/ecommerce-app-development' || pathname === '/music-app-development-company' || pathname === '/social-media-app-development-company' || pathname === '/real-estate-app-development-company' || pathname === '/automotive-software-development' || pathname === '/fintech-app-development' || pathname.startsWith('/case-studies/');
